 ...
 * To convert MP3's to ASL3 acceptable WAV files you can use FFMPEG. Example: ```ffmpeg -i input.mp3 -ac 1 -ar 8000 -sample_fmt s16 -filter:a "volume=0.5" output.wav```. If you don't have FFMPEG apt install it.
